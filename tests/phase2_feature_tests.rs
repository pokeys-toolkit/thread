...
fn test_servo_commands() {
    ...
    let angle_cmd = DeviceCommand::SetServoAngle {
        pin: 17,
        angle: 90.0,
    };
    match angle_cmd {
    ...
    let speed_cmd = DeviceCommand::SetServoSpeed {
        pin: 18,
        speed: 50.0,
    };
    match speed_cmd {
...
fn test_i2c_address_validation() {
    ...
    for address in valid_addresses {
        ...
        let read_cmd = DeviceCommand::I2cRead { address, length: 1 };
        match read_cmd {
...
fn test_servo_type_variants() {
    ...
    let servo_180 = ServoType::OneEighty {
        pos_0: 1000,
        pos_180: 2000,
    };
    match servo_180 {
    ...
    let servo_360_pos = ServoType::ThreeSixtyPosition {
        pos_0: 500,
        pos_360: 2500,
    };
    match servo_360_pos {
